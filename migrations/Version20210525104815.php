 ...
 */
final class Version20210525104815 extends AbstractMigration
{
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE fiche_notes DROP FOREIGN KEY FK_7B9B4CB3895648BC');
        $this->addSql('ALTER TABLE fiche_notes DROP FOREIGN KEY FK_7B9B4CB3E455FCC0');
        ...
        $this->addSql('DROP TABLE fiche_notes');
